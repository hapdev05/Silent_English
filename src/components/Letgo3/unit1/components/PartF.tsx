...
import slowly from "@/assets/videos/unit1/borrow.mp4"
...
const availableSentences = [
  "I see that Mai has some paintbrushes.",
  "No, but I have red and yellow.",
  "I'm painting a sunset, but it's hard to get the colors just right.",
  "Do you have any paintbrushes?"
]
  ...
  return (
    <div className="max-w-4xl mx-auto ">
      ...
      <div className="mb-8 border rounded-lg p-6 bg-white shadow">
            ...
            {availableSentences.map((sentence, index) => (
              <div
                ...
                className={`p-3 rounded cursor-move transition-colors ${
                  placedSentences.includes(sentence) 
                    ? "opacity-50 bg-gray-100 border border-gray-300" 
                    : "opacity-100 bg-blue-50 hover:bg-blue-100 border border-blue-200"
                }`}
              >
                {sentence}
              </div>
        ...
        {feedback && feedback.includes("Not quite") && (
          <div className="p-4 bg-blue-50 rounded-lg mb-6">
            <h4 className="font-bold mb-2">Đáp án:</h4>
            <ol className="list-decimal list-inside space-y-1 ml-4">
              <li>No, but I have red and yellow.</li>
              <li>Do you have any paintbrushes?</li>
              <li>I see that Mai has some paintbrushes.</li>
              <li>I'm painting a sunset, but it's hard to get the colors just right.</li>
            </ol>
          </div>
        )}
