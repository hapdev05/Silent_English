      ...
      >
        ...
        >
          <h1 className="text-4xl font-bold mb-4">
            Trẻ Diếc cần được học Ngôn ngữ sớm
          </h1>
          <p className="text-xl">để phát triển tư duy và nhận thức</p>
        </motion.div>
      </motion.div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            Dự án Nâng cao chất lượng giáo dục học sinh khiếm thính cấp tiểu học
            thông qua ngôn ngữ ký hiệu (QIPEDC) do Quỹ Hợp tác toàn cầu...
          </p>
